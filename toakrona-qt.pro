...
# Change paths if needed, these use the toakrona/deps.git repository locations
...
contains(TOAKRONA_NEED_QT_PLUGINS, 1) {
    DEFINES += TOAKRONA_NEED_QT_PLUGINS
...
contains(TOAKRONA_QT_TEST, 1) {
SOURCES += src/qt/test/test_main.cpp \
    src/qt/test/uritests.cpp
HEADERS += src/qt/test/uritests.h
DEPENDPATH += src/qt/test
QT += testlib
TARGET = toakrona-qt_test
DEFINES += TOAKRONA_QT_TEST
}

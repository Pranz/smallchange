...
uint256 hashGenesisBlock("0x53f873cd804a9711302d2b234f05ee7b7a7dfb11a1b5b835a04672d4c2f82bc2");
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x3cfc776fd49934a570cc3e9c4f15bd4cc9b62ddab1ee24d3ec4e92f32f5fa074");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1387802626; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1657613;

        if (fTestNet)
        {
            block.nTime    = 1387802626;
            block.nNonce   = 1461907;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x53f873cd804a9711302d2b234f05ee7b7a7dfb11a1b5b835a04672d4c2f82bc2"));

...
QT_TRANSLATE_NOOP("bitcoin-core", "Toakrona version"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error loading wallet.dat: Wallet requires newer version of Toakrona"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the Toakrona Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Select the version of socks proxy to use (4-5, default: 5)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Send command to -server or toakronad"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Specify configuration file (default: toakrona.conf)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Specify connection timeout in milliseconds (default: 5000)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Specify data directory"),
QT_TRANSLATE_NOOP("bitcoin-core", "Specify pid file (default: toakronad.pid)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart Toakrona to complete"),

...
// TODO: implement URI support on the Mac.
    ...
    {
        if (boost::algorithm::istarts_with(argv[i], "toakrona:"))
        {
    ...
    app.setOrganizationName("toakrona");
    app.setOrganizationDomain("we-have-no-domain-yet.nex");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("toakrona-qt-testnet");
    else
        app.setApplicationName("toakrona-qt");
